    ...
    switch (currentStep) {
      case 1:
        return (
          <div className="poschange">
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Anxiety level" 
              type="number"
              id="anxiety_level"
              name="anxiety_level"
              value={formValues.anxiety_level}
              ...
              className="form-control"
            />
          <p className="txtclr">Anxiety is a common mental health condition characterized by feelings of unease, worry, and fear. It is often accompanied by physical symptoms such as rapid heartbeat, sweating, trembling, and shortness of breath. People with anxiety may experience persistent thoughts of potential danger or catastrophic outcomes, even in situations that may not warrant such concern. Anxiety can significantly impact daily life, relationships, and overall well-being, making it challenging to engage in normal activities or enjoy a sense of peace. </p>
          </div>
      ...
      case 2:
        return (
          <div>
            <label htmlFor="self_esteem" className="form-label">
            <img src={img2} style={{ objectFit:"cover", width:"500px", height:"100%", display:"flex"}}/>
              
            </label>
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Self Esteem" 
              type="number"
              id="self_esteem"
              name="self_esteem"
              value={formValues.self_esteem}
      ...
      case 3:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Mental Health History"
              type="number"
              id="mental_health_history"
              name="mental_health_history"
              value={formValues.mental_health_history}
      ...
      case 4:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Depression"
              type="number"
              id="depression"
              name="depression"
              value={formValues.depression}
      ...
      case 5:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500\px",onClick:"noChange"}} placeholder="Headache"
              type="number"
              id="headache"
              name="headache"
              value={formValues.headache}
      ...
      case 6:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Blood Pressure"
              type="number"
              id="blood_pressure"
              name="blood_pressure"
              value={formValues.blood_pressure}
      ...
      case 7:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Sleep quality"
              type="number"
              id="sleep_quality"
              name="sleep_quality"
              value={formValues.sleep_quality}
      ...
      case 8:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Breathing Problem"
              type="number"
              id="breathing_problem"
              name="breathing_problem"
              value={formValues.breathing_problem}
      ...
      case 9:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Noise level"
              type="number"
              id="noise_level"
              name="noise_level"
              value={formValues.noise_level}
      ...
      case 10:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Living Conditions"
              type="number"
              id="living_conditions"
              name="living_conditions"
              value={formValues.living_conditions}
      ...
      case 11:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Safety"
              type="number"
              id="safety"
              name="safety"
              value={formValues.safety}
      ...
      case 12:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Basic Needs"
              type="number"
              id="basic_needs"
              name="basic_needs"
              value={formValues.basic_needs}
              ...
              className="form-control"
            />
            <p className="txtclr">Basic needs are the fundamental requirements necessary for survival, well-being, and a decent quality of life. They encompass essential elements that every individual requires to thrive and function optimally. These needs typically include access to clean air, water, and nutritious food to sustain physical health. Adequate shelter and clothing provide protection from the elements and ensure a safe living environment.</p>
          </div>
        );
      case 13:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Academice Performance"
              type="number"
              id="academic_performance"
              name="academic_performance"
              value={formValues.academic_performance}
      ...
      case 14:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Study Load"
              type="number"
              id="study_load"
              name="study_load"
              value={formValues.study_load}
      ...
      case 15:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Teacher Student Relationship"
              type="number"
              id="teacher_student_relationship"
              name="teacher_student_relationship"
              value={formValues.teacher_student_relationship}
      ...
      case 16:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Future Career Concerns"
              type="number"
              id="future_career_concerns"
              name="future_career_concerns"
              value={formValues.future_career_concerns}
      ...
      case 17:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Social Support"
              type="number"
              id="social_support"
              name="social_support"
              value={formValues.social_support}
      ...
      case 18:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Peer Pressure"
              type="number"
              id="peer_pressure"
              name="peer_pressure"
              value={formValues.peer_pressure}
      ...
      case 19:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Extracurricular Activities"
              type="number"
              id="extracurricular_activities"
              name="extracurricular_activities"
              value={formValues.extracurricular_activities}
      ...
      case 20:
        return (
          <div>
            ...
            <input style={{border:"solid 2px",width:"500px",onClick:"noChange"}} placeholder="Bullying"
              type="number"
              id="bullying"
              name="bullying"
              value={formValues.bullying}
